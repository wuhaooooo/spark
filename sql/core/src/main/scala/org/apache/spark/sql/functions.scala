...
// scalastyle:on
   ...
   * Key lengths of 128 can be used. If either argument is NULL, the result will also be null. If
   * input is invalid, key length is not one of the permitted values, an exception will be thrown.
   *
   * @param input binary column to encrypt input
   * @param key binary column of 128 bits key
   *
   * @group misc_funcs
   * @since 2.1.0
   */
  ...
  /**
   * Decrypts input using AES and Returns the result as a binary column.
    * Key lengths of 128 can be used. If either argument is NULL, the result will also be null. If
    * input is invalid, key length is not one of the permitted values, an exception will be thrown.
   *
